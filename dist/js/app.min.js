...
var WebFontConfig={google:{families:["Oswald:300","EB Garamond","Lobster"]},timeout:2e3};!function(){var t=document.createElement("script");t.src=("https:"==document.location.protocol?"https":"http")+"://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js",t.async="true",document.head.appendChild(t)}();
!function(){var o=document.querySelectorAll(".parallax"),n=.8;window.onscroll=function(){[].slice.call(o).forEach(function(o,l){var c=window.pageYOffset,a="50% "+c*n+"px";o.style.backgroundPosition=a})}}();